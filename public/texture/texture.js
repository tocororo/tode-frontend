(function (global, factory) {
  ...
  */
  ...
  JournalArticleRef.schema = {
    ...
    doi: substance.STRING, // <pub-id pub-id-type="doi">
    pmid: substance.STRING, // <pub-id pub-id-type="pmid">
    issn: substance.STRING // <pub-id pub-id-type="pmid">
  };
...
<article xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ali="http://www.niso.org/schemas/ali/1.0">
  ...
  */
  ...
  class AddEntityWorkflow extends EditMetadataWorkflow {
    didMount () {
      super.didMount();
  ...
  class AddAuthorWorkflow extends AddEntityWorkflow {
    _createContent () {
      this.context.api.addAffiliation();
    }
  }

  class AddAuthorWorkflow$1 extends AddEntityWorkflow {
    _createContent () {
  ...
  var ManuscriptPackage = {
    ...
    configure (config) {
      ...
      // Workflows
      config.addComponent('add-affiliation-workflow', AddAuthorWorkflow);
      config.addComponent('add-author-workflow', AddAuthorWorkflow$1);
  ...
  class AbstractsSectionComponent extends MetadataCollectionComponent {
    didMount () {
  ...
  class AddAffiliationCommand$1 extends AddEntityCommand {
    execute (params, context) {
      context.api.addAffiliation();
    }
  }

  class AddAuthorCommand$2 extends AddEntityCommand {
    execute (params, context) {
      context.api.addAuthor();
    }
  }

  class AddCustomAbstractCommand extends AddEntityCommand {
    execute (params, context) {
      context.api.addCustomAbstract();
    }
  }

  class AddEditorCommand extends AddEntityCommand {
    execute (params, context) {
      context.api.addEditor();
    }
  }

  class AddGroupCommand extends AddEntityCommand {
    execute (params, context) {
      context.api.addGroup();
    }
  }

  class AddFunderCommand extends AddEntityCommand {
    execute (params, context) {
      context.api.addFunder();
    }
  }

  class AddKeywordCommand extends AddEntityCommand {
    execute (params, context) {
      context.api.addKeyword();
    }
  }

  class AddSubjectCommand extends AddEntityCommand {
    execute (params, context) {
  ...
  class AbstractTypeEditor extends DropdownEditor {
    _getLabel () {
  ...
  class CustomAbstractComponent extends DefaultNodeComponent {
    _getClassNames () {
  ...
  var MetadataPackage = {
    ...
    configure (articleConfig) {
      ...
      config.addCommand('add-author', AddAuthorCommand$2);
      config.addCommand('add-affiliation', AddAffiliationCommand$1);
  ...
  function _exportElementCitation (node, exporter) {
    ...
    el.append(_createTextElement$1($$, node.issn, 'pub-id', { 'pub-id-type': 'issn' }));
