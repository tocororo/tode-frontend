...
import { Accordion, Icon, Container,  Segment, Header, Grid, Button} from 'semantic-ui-react'
      ...
      return (
        <Container>   
          <Grid columns={6} divided>
              ...
              docs.map(doc =>   
              perms.map(perm => 
                oauth2IsAuthenticated &&  oauth2Users._id === perm.document._id &&  oauth2Users._id === perm.withPermisions._id && oauth2Users._id !== perm.document.document_user && perm.requestAcepted === true ?  
                    ...
                    <Fragment>
                      <Grid columns={6} celled>
                        <Grid.Row color='blue'>
                            ...
                            <Grid.Column>{perm.withPermisions.rol}</Grid.Column>
                            <Grid.Column><Moment fromNow>{perm.document.createdAt}</Moment></Grid.Column>
                        </Grid.Row>  
                      </Grid>   
                    </Fragment>
                  </Accordion.Title>
